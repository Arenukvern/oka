...
> Open work now lives in [docs/PHASE_CHECKLIST.mdx](../PHASE_CHECKLIST).
...
- **ADR:** [0006](../decisions/0006-dart-entrypoint-hooks) (accepted)
...
- **Status:** in progress
- **Scope:** see [hardening roadmap](../guides/hardening_roadmap)
...
- [x] Q&A blocks for init / compare / debug-step in `docs/guides/build_and_config.mdx`
