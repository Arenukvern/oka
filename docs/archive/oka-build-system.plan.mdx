...
> lives in [ADR-0011](../decisions/0011-hot-reload-run-loop) and
> [docs/guides/hot_reload_plan.mdx](../guides/hot_reload_plan). Phase 4
...
- Hot reload: under 200ms for Dart changes
- Native incremental: under 2s for small native changes
- Size: under 10MB tool distribution
