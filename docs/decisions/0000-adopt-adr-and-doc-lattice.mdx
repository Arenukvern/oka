...
- `docs/start_here/why_this_repo_matters.mdx` — charter: ownership + boundaries
- `docs/decisions/` — MADR-style ADRs, append-only, this index
- `docs/guides/design_faq.mdx` / `docs/guides/build_and_config.mdx` — why / how Q&A per FAQ-driven development
