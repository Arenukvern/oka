...
- **Executable plan:** [docs/guides/hot_reload_plan.mdx](../guides/hot_reload_plan)

## Context

oka's north star is agentic workflows: "an agent can fix a broken build from
oka's error messages alone" ([why this repo matters](../start_here/why_this_repo_matters)).
...
[hot reload plan](../guides/hot_reload_plan).
