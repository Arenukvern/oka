...
| Manage spawned processes (emulators, browsers) / stop leaks | [Process lifecycle guide](/guides/process_lifecycle) |
| Design a declarative process/resource composition API | [Resource composition plan](/guides/resource_composition_plan) |
